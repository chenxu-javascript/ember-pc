...
define('ember-power-calendar/test-support/index', ['exports', 'ember-test-helpers/wait', 'ember-native-dom-helpers', 'moment'], function (exports, _wait, _emberNativeDomHelpers, _moment) {
  ...
  exports.calendarCenter = calendarCenter;
  exports.calendarSelect = calendarSelect;
...
define('ember-power-select/test-support/helpers', ['exports', 'ember-test-helpers/wait', 'ember-native-dom-helpers'], function (exports, _wait, _emberNativeDomHelpers) {
  ...
  exports.default = function () {
    ...
    Ember.Test.registerAsyncHelper('selectSearch', async function (app, cssPathOrTrigger, value) {
      ...
      let isMultipleSelect = !!(0, _emberNativeDomHelpers.find)('.ember-power-select-trigger-multiple-input', trigger);

      let content = (0, _emberNativeDomHelpers.find)(`#${contentId}`);
      let dropdownIsClosed = !content || content.classList.contains('ember-basic-dropdown-content-placeholder');
      if (dropdownIsClosed) {
        await (0, _emberNativeDomHelpers.click)(trigger);
        await (0, _wait.default)();
      }
      let isDefaultSingleSelect = !!(0, _emberNativeDomHelpers.find)('.ember-power-select-search-input');

      if (isMultipleSelect) {
        await (0, _emberNativeDomHelpers.fillIn)((0, _emberNativeDomHelpers.find)('.ember-power-select-trigger-multiple-input', trigger), value);
      } else if (isDefaultSingleSelect) {
        await (0, _emberNativeDomHelpers.fillIn)('.ember-power-select-search-input', value);
      } else {
        // It's probably a customized version
        let inputIsInTrigger = !!(0, _emberNativeDomHelpers.find)('.ember-power-select-trigger input[type=search]', trigger);
        if (inputIsInTrigger) {
          await (0, _emberNativeDomHelpers.fillIn)((0, _emberNativeDomHelpers.find)('input[type=search]', trigger), value);
        } else {
          await (0, _emberNativeDomHelpers.fillIn)(`#${contentId} .ember-power-select-search-input[type=search]`, 'input');
        }
      }
      return (0, _wait.default)();
    });
    ...
    Ember.Test.registerAsyncHelper('removeMultipleOption', async function (app, cssPath, value) {
      let elem;
      let items = (0, _emberNativeDomHelpers.findAll)(`${cssPath} .ember-power-select-multiple-options > li`);
      ...
      try {
        await (0, _emberNativeDomHelpers.click)(elem);
        return (0, _wait.default)();
      } catch (e) {
    ...
    Ember.Test.registerAsyncHelper('clearSelected', async function (app, cssPath) {
      let elem = (0, _emberNativeDomHelpers.find)(`${cssPath} .ember-power-select-clear-btn`);
      try {
        await (0, _emberNativeDomHelpers.click)(elem);
        return (0, _wait.default)();
      } catch (e) {
  ...
  function findContains(selector, text) {
    return (0, _emberNativeDomHelpers.findAll)(selector).filter(e => e.textContent.trim().indexOf(text) > -1)[0];
  }
  ...
  async function selectChoose(cssPathOrTrigger, valueOrSelector, optionIndex) {
    ...
    let options = (0, _emberNativeDomHelpers.findAll)(`#${contentId} .ember-power-select-option`);
    ...
    if (potentialTargets.length === 0) {
      ...
      if (matchEq) {
        ...
        let option = (0, _emberNativeDomHelpers.findAll)(`#${contentId} ${valueOrSelector.slice(0, -6)}`)[index];
    ...
    await (0, _emberNativeDomHelpers.click)(target);
    return (0, _wait.default)();
  }
